#!/usr/bin/env bash
#
# Sorter — reassign scorers (Linux launcher).
#
# Run ./"Start Reassign.sh" from a terminal (first time: chmod +x "Start Reassign.sh").
#
...
echo
echo -e "  ${CYAN}==================================================================${NC}"
echo -e "  ${BOLD}                  SORTER — REASSIGN SCORERS                       ${NC}"
echo -e "  ${CYAN}==================================================================${NC}"
echo
